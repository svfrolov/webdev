...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        # Проверяем, есть ли уже объекты недвижимости
        if RealEstate.objects.exists():
            self.stdout.write(self.style.WARNING('Объекты недвижимости уже существуют в базе данных.'))
            return
        ...
        self.stdout.write(self.style.SUCCESS(f'Успешно создано {len(real_estates)} объектов недвижимости'))